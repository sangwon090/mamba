...
fn test_lexer() {
    ...
    assert_eq!(tokens[23], Token::Identifier(Identifier("a".into())));
    assert_eq!(tokens[24], Token::Plus);
    assert_eq!(tokens[25], Token::Identifier(Identifier("b".into())));
    assert_eq!(tokens[26], Token::Semicolon);
    assert_eq!(tokens[27], Token::Dedent);
    assert_eq!(tokens[28], Token::Keyword(Keyword::Def));
    assert_eq!(tokens[29], Token::Identifier(Identifier("main".into())));
    ...
    assert_eq!(tokens[36], Token::Identifier(Identifier("print".into())));
